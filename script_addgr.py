...
""" 
Lists of IPs took from function "remove_dup_ips.py" on Cisco ASA that remove all duplicate IPs and generete a new file to use here
to create the objects in Fortigate.
"""
def create_objects():
    for name in objects:
        if name in objects:
